...
export const CHARACTER_MODIFIERS: readonly ModifierDef[] = [
    ...
    {label: "defined by", picker: (p) => pickAny(p,  "Condition", "Outcome", "Action")},
    ...
    {label: "survivor of", picker: (p) => pickAny(p,  "Action")},
    ...
    {label: "plans", picker: (p) => pickAny(p,  "Condition", "Outcome", "Action")},
...
export const PLACE_MODIFIERS: readonly ModifierDef[] = [
    ...
    {label: "missing", picker: (p) => pickAny(p, "Object", "Outcome", "Condition")},
    {label: "fearing", picker: (p) => pickAny(p, "Object", "Outcome", "Condition")},
    {label: "defined by", picker: (p) => pickAny(p, "Object", "Outcome", "Condition")},
    {label: "run by", picker: (p) => pickBeing(p)},
    {label: "opposes", picker: (p) => pickBeing(p)},
    {label: "fears", picker: (p) => pickAny(p, "Object", "Outcome", "Condition")},
    {label: "everyone has", picker: (p) => pickAny(p, "Object", "Outcome","Condition")},
    {label: "no one has", picker: (p) => pickAny(p, "Object", "Outcome", "Condition")},
    {label: "has", picker: (p) => pickAny(p, "Object", "Outcome", "Condition", "Action", "Origin", "Attribute")},
    {label: "for", picker: (p) => pickAny(p,  "Condition", "Outcome")},
    {label: "haunted by", picker: (p) => pick(p, "Spirit") },
    {label: "guards", picker: (p) => pick(p, "Object")},
    {label: "forbidden to", picker: (p) => (maybe() ? pick(p, "Human") : pickBeing(p))},
    {label: "transformed by", picker: (p) => (pick(p, "Origin"))},
